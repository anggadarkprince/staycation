...
const PrivacyPage = props => {
    useEffect(() => {
        document.title = "Staycation | Privacy Policy";
        backToTop();
    });
        ...
        <>
            <Fade bottom>
                <div className='container mb-5'>
                    ...
                    <p className="text-muted">Last updated 20 April 2020</p>

                    <p>
                        Company Name operates the Staycation website, which provides the SERVICE.
                    </p>
                    <p>
                        This page is used to inform website visitors regarding our policies with the collection, use, and
                        disclosure of Personal Information if anyone decided to use our Service, the Website Name website.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        personally identifiable information, including but not limited to your name, phone number, and postal address. The
                    ...
                    <p>
                        ...
                        sends to us that is called Log Data. This Log Data may include information such as your computer's Internet
                        Protocol (“IP”) address, browser version, pages of our Service that you visit, the time and date of your visit,
                    ...
                    <h5 className="mt-4">Service Providers</h5>
                    <p>
                    ...
                    <h5 className="mt-4">Links to Other Sites</h5>
                    <p>
                    ...
                    <p>
                        ...
                        identifiable information from children under 13. In the case we discover that a child under 13 has provided us with
