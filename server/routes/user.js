...
router.post('/save', authorization.isAuthorized(permissions.PERMISSION_USER_CREATE), upload, user.save);
router.get('/edit/:id', authorization.isAuthorized(permissions.PERMISSION_USER_EDIT), user.edit);
router.post('/update/:id', authorization.isAuthorized(permissions.PERMISSION_USER_EDIT), upload, user.update);
