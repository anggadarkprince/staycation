...
router.post('/save', authorization.isAuthorized(permissions.PERMISSION_BANK_CREATE), upload, bank.save);
router.get('/edit/:id', authorization.isAuthorized(permissions.PERMISSION_BANK_EDIT), bank.edit);
router.post('/update/:id', authorization.isAuthorized(permissions.PERMISSION_BANK_EDIT), upload, bank.update);
